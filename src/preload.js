...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  startDownload: (baseUrl, files, targetDir, createSubfolder, extractAndDelete, extractPreviouslyDownloaded, maxConcurrentDownloads, isThrottlingEnabled, throttleSpeed, throttleUnit) => ipcRenderer.invoke('start-download', baseUrl, files, targetDir, createSubfolder, extractAndDelete, extractPreviouslyDownloaded, maxConcurrentDownloads, isThrottlingEnabled, throttleSpeed, throttleUnit),
